...
1. **Read** `templates/viewer.html` with the current harness's file-reading capability
2. **Study** the exact structure, styling, and neutral viewer system
...
The HTML artifact contains everything: p5.js (from CDN), the algorithm, parameter controls, and UI - all in one file that works immediately in artifact-capable agent harnesses or any browser. Start from the template file, not from scratch.
...
To allow exploration of the generative art, create a single, self-contained HTML artifact. Ensure this artifact works immediately in artifact-capable agent harnesses or any browser - no setup required. Embed everything inline.
...
- Neutral viewer styling (UI colors, fonts, gradients)
...
- Keep the neutral viewer styling (UI styling, not art colors)

### USING THE ARTIFACT

The HTML artifact works immediately:
1. **In artifact-capable harnesses**: Displayed as an interactive artifact - runs instantly
...
**The constants**:
- Neutral viewer styling (colors, fonts, layout)
...
- **templates/viewer.html**: REQUIRED STARTING POINT for all HTML artifacts.
  - This is the foundation - contains the exact structure and neutral viewer styling
...
- But DO keep the exact UI structure and neutral viewer styling from the template
