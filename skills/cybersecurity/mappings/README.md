# MITRE ATT&CK Navigator Layer - Cybersecurity Skills

This directory contains a MITRE ATT&CK Navigator layer file that maps the coverage of the Cybersecurity Skills repository against the ATT&CK Enterprise matrix.
