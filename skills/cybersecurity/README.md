<p align="center">
  <img src="assets/banner.png" alt="Cybersecurity Skills" width="100%">
</p>
...
[![GitHub stars](https://img.shields.io/github/stars/mukul975/Cybersecurity-Skills?style=flat-square)](https://github.com/mukul975/Cybersecurity-Skills/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/mukul975/Cybersecurity-Skills?style=flat-square)](https://github.com/mukul975/Cybersecurity-Skills/network/members)
[![Last Commit](https://img.shields.io/github/last-commit/mukul975/Cybersecurity-Skills?style=flat-square)](https://github.com/mukul975/Cybersecurity-Skills/commits/main)
...
> ⚠️ **Community Project** — This is an independent, community-created project. No vendor affiliation. 
...
npx skills add mukul975/Cybersecurity-Skills

# Option 2: Git clone
git clone https://github.com/mukul975/Cybersecurity-Skills.git
...
An **ATT&CK Navigator layer file** is included in the [v1.0.0 release assets](https://github.com/mukul975/Cybersecurity-Skills/releases/tag/v1.0.0) for visual coverage mapping. 
...
**AI code assistants**
Claude Code () · GitHub Copilot (Microsoft) · Cursor · Windsurf · Cline · Aider · Continue · Roo Code · Amazon Q Developer · Tabnine · Sourcegraph Cody · JetBrains AI 
...
| **SkillsLLM** | Skills directory & marketplace | [skillsllm.com/skill/cybersecurity-skills](https://skillsllm.com/skill/cybersecurity-skills) |
| **Openflows** | Signal analysis & tracking | [openflows.org](https://openflows.org/currency/currents/cybersecurity-skills/) |
| **NeverSight skills_feed** | Automated skills index | [NeverSight/skills_feed](https://github.com/NeverSight/skills_feed) |

## Star history

<a href="https://star-history.com/#mukul975/Cybersecurity-Skills&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=mukul975/Cybersecurity-Skills&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=mukul975/Cybersecurity-Skills&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=mukul975/Cybersecurity-Skills&type=Date" width="100%" />
 </picture>
</a>
...
|---|---|---|
| [v1.0.0](https://github.com/mukul975/Cybersecurity-Skills/releases/tag/v1.0.0) | March 11, 2026 | 734 skills · 26 domains · MITRE ATT&CK + NIST CSF 2.0 mapping · ATT&CK Navigator layer |

Skills have continued to grow on `main` since v1.0.0 — the library now contains **817 skills** with **6-framework mapping**  (MITRE ATLAS, D3FEND, NIST AI RMF, and the MITRE Fight Fraud Framework added post-release).  Check [Releases](https://github.com/mukul975/Cybersecurity-Skills/releases) for the latest tagged version.
...
**Report issues** — Found an inaccurate procedure or broken script? [Open an issue](https://github.com/mukul975/Cybersecurity-Skills/issues).

Every PR is reviewed for technical accuracy and agentskills.io standard compliance within 48 hours.  Check [good first issues](https://github.com/mukul975/Cybersecurity-Skills/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) for a starting point.
...
💬 [Discussions](https://github.com/mukul975/Cybersecurity-Skills/discussions) — Questions, ideas, and roadmap conversations
🐛 [Issues](https://github.com/mukul975/Cybersecurity-Skills/issues) — Bug reports and feature requests
...
```bibtex
@software{_cybersecurity_skills,
  author       = {Jangra, Mahipal},
  title        = {Cybersecurity Skills},
  year         = {2026},
  url          = {https://github.com/mukul975/Cybersecurity-Skills},
  license      = {Apache-2.0},
...
[⭐ Star](https://github.com/mukul975/Cybersecurity-Skills/stargazers) · [🍴 Fork](https://github.com/mukul975/Cybersecurity-Skills/fork) · [💬 Discuss](https://github.com/mukul975/Cybersecurity-Skills/discussions) · [📝 Contribute](CONTRIBUTING.md)

Community project by [@mukul975](https://github.com/mukul975). No vendor affiliation.
