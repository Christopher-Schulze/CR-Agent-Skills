...
- Aim for a heads-turning, product-specific moment when the surface can support it. This is not a hard requirement for quiet utility work; when spectacle would hurt the task, make the memorable quality come from precision, clarity, restraint, and exact product fit.
